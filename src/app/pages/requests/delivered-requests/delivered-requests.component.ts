...
@Component({
    selector: 'app-delivered-requests',
    templateUrl: './delivered-requests.component.html',
    styleUrls: ['./delivered-requests.component.css']
})
export class DeliveredRequestsComponent implements OnInit {
