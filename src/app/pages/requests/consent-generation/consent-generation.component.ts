...
@Component({
    selector: 'app-consent-generation',
    templateUrl: './consent-generation.component.html',
    styleUrls: ['./consent-generation.component.css']
})
export class ConsentGenerationComponent implements OnInit {
