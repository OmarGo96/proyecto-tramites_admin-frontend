...
@Component({
    selector: 'app-complementary-docs-validation',
    templateUrl: './complementary-docs-validation.component.html',
    styleUrls: ['./complementary-docs-validation.component.css']
})
export class ComplementaryDocsValidationComponent implements OnInit {
