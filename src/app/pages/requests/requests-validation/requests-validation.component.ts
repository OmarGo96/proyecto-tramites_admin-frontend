...
@Component({
    selector: 'app-requests-validation',
    templateUrl: './requests-validation.component.html',
    styleUrls: ['./requests-validation.component.css']
})
export class RequestsValidationComponent implements OnInit {
